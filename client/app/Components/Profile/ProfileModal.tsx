      ...
      >
        ...
        <div className="mt-4 relative flex justify-between">
          <div className="relative inline-block">
            ...
            />
            <div className="absolute top-[55px] border-0 right-1 ">
        ...
        >
          ...
          <div className="pt-4 grid grid-cols-[150px_1fr] border-t-2 border-t-[#323232]">
          ...
          <div className="flex justify-end gap-4 border-t-2 border-t-[#323232]/10">
            <button
              className="mt-3 py-2 px-4 bg-transparent text-black text-sm font-medium rounded-md border-2 border-[#323232]/10 hover:bg-[#eb4e31] hover:border-transparent hover:text-white 
            ...
            <button
              type="submit"
              className="mt-3 py-2 px-4 bg-blue-500 text-white text-sm font-medium rounded-sm 
